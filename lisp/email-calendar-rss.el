...
(use-package elfeed
  ...
  (setq elfeed-feeds
        '(("https://joeyh.name/blog/index.rss" debian linux)
          ...
          ("https://lukesmith.xyz/rss.xml" discourse linux)
		  ("https://www.theregister.com/headlines.atom" technews)
		  ("https://karl-voit.at/feeds/lazyblorg-all.atom_1.0.links-only.xml" privacy)
		  ("https://corfield.org/atom.xml" clojure)
		  ("https://pluralistic.net/feed/" discourse)
		  ("https://jl.ly/index.rss" tech)
          ...
          ("https://thelibre.news/latest/rss" freesoftware technews)
          ("https://drewdevault.com/blog/index.xml" freesoftware)
          ("https://landchad.net/rss.xml" linux)
          ("https://lobste.rs/rss" firehose)
		  ("https://www.reddit.com/r/stallmanwasright.rss" freesoftware)
		  ("https://plaintextproject.online/feed.xml" plaintext)
		  ("https://www.romanzolotarev.com/rss.xml" BSD)
		  ("http://feeds.bbci.co.uk/news/politics/rss.xml" news)
		  ("http://feeds.bbci.co.uk/news/uk/rss.xml" news)
		  ...
		  ("https://protesilaos.com/master.xml" personal emacs discourse)
		  ("https://www.c0ffee.net/rss" bsd)
