...
#+RESULTS:
| #<subr F616e6f6e796d6f75732d6c616d626461_anonymous_lambda_92> | clojure--check-wrong-major-mode | eglot-ensure | clojure-ts-mode | paredit-mode |
...
* pi-coding-agent
This doesn't work so out you go.
#+begin_src elisp :tangle yes
