...
First thing we need to do is install denote:
...
Then we need to ensure we have denote-silo available because this allows us to have separate work and home denote directories:
